        ...
        <div class="offer-title">
            ...
            <div class="title_right">
                <div class="form-group pull-right">
                    <a href="{{ URL::to('/content/add_image_gallery') }}" class="btn btn-primary btn-sm">Add New Gallery</a>
                </div>
            </div>
        </div>
                        ...
                        <table class="display table table-striped jambo_table bulk_action">
                            ...
                            <tbody id="contentTable">
                                ...
                                <tr class="odd pointer">
                                    ...
                                    <td class="last">
                                        <a href="edit_album/{{ $gallery->pk_content_id }}" class="btn btn-primary btn-sm">View & Edit</a>
        ...
        $(document).on("click", ".show-alert", function (e) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result == true) {
                        window.location.href = "{{ URL::to('/content/delete_album/') }}/" + id;
                    }
                }
            });
        });
